  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-[#04205f]/80 backdrop-blur-md shadow-lg shadow-sky-400/50">
      <nav className="container mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden sm:flex space-x-6">
          <Link href="/" className="text-white hover:text-sky-300 transition-colors">Home</Link>
          <Link href="/blog" className="text-white hover:text-sky-300 transition-colors">Blog</Link>
          <Link href="/about" className="text-white hover:text-sky-300 transition-colors">About</Link>
          <Link href="/contact" className="text-white hover:text-sky-300 transition-colors">Contact</Link>
          <Link href="/disclaimer" className="text-white hover:text-sky-300 transition-colors">Disclaimer</Link>
        </div>
      ...
      <div
        className={`sm:hidden fixed top-[72px] right-4 w-60 bg-[#04205f]/95 p-6 rounded-lg shadow-xl z-40 transition-all duration-300 ease-in-out
          ${isMenuOpen ? 'slide-in' : 'slide-out hidden'}`}
      >
        <ul className="flex flex-col space-y-4">
          {[
            ...
            <li key={href}>
              <Link
                href={href}
                className="text-white hover:text-sky-300 transition-colors text-lg"
                onClick={toggleMenu}
              >
                {label}
              </Link>
